...
// THIS PROJECT IS MADE BY SARTHAK GARG(2K21/B9/34)
...
printf("\n");
     ...
     printf("\n");
     printf("Sarthak Garg(2K21/B9/34)");
     printf("\n");
     printf("In supervision Of:");
     printf("\n");
     printf("Dr. Rajeev Kumar\n");
gotoxy(35,20);
t();
gotoxy(35,21);
...
system("color B"); //copy all item from temporary file to fp except that
